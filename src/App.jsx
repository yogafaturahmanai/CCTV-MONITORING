    ...
    <div className="dashboard-app-shell">
      ...
      <aside className="app-sidebar">
        <div className="sidebar-brand">
          <div className="sidebar-cctv-icon-badge">
            <img src={cctvIcon} alt="CCTV Icon" className="sidebar-cctv-img" />
          </div>
          <div className="brand-text">
            <h1 className="brand-title">IT Operations CCTV Monitoring Center</h1>
            <p className="brand-sub">Centralized NVR Monitoring, Storage Retention &amp; Video Loss Alert Platform.</p>
          </div>
        </div>
